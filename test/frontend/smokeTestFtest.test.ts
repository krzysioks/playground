...
const unregisteredUser: UserTestType = {
    _id: correctUserId,
    username: 'jakob',
...
const userToRegister: UserTestType = {
...
const notValidUserToRegister: UserTestType = {
    _id: userToRegisterId,
    username: 'M',
    ...
    test('Should log in and log out successfully registered user', done => {
        puppeteer
            ...
            .then(async browser => {
                ...
                await page.keyboard.type(correctUser.username as string);
                //.. password fields
                await page.focus(
                    '#playground > div > div > div > form > div:nth-child(2) > input'
                );
                await page.keyboard.type(correctUser.password as string);
    ...
    test('Should not log in if user is not registered', done => {
        puppeteer
            ...
            .then(async browser => {
                ...
                await page.keyboard.type(unregisteredUser.username as string);
                //.. password fields
                await page.focus(
                    '#playground > div > div > div > form > div:nth-child(2) > input'
                );
                await page.keyboard.type(unregisteredUser.password as string);
                //click on login button
                await page.click(
                    '#playground > div > div > div > form > div.d-flex.flex-row.justify-content-between.mt-2 > button:nth-child(1)'
                );
    ...
    test('Should register user with valid data', done => {
        puppeteer
            ...
            .then(async browser => {
                ...
                await page.keyboard.type(userToRegister.username as string);

                //.. password
                await page.focus(
                    '#playground > div > div > div > form > div:nth-child(2) > input'
                );
                await page.keyboard.type(userToRegister.password as string);
                ...
                await page.keyboard.type(userToRegister.email as string);
        ...
        puppeteer
            ...
            .then(async browser => {
                ...
                await page.keyboard.type(
                    notValidUserToRegister.username as string
                );
                ...
                await page.keyboard.type(
                    notValidUserToRegister.password as string
                );
                ...
                await page.keyboard.type(
                    notValidUserToRegister.email as string
                );
